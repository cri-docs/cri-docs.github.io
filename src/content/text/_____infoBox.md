...
Für das Verfassen dieses Handbuchs hat sich die Arbeitsgruppe «Kritische Dokumentationspraxis» (AG) zu folgendem Umgang mit Sprache und Bildern entschieden:
...
* Die beiden Begriffe «schwarz» und «weiss» werden folgendermassen geschrieben: Schwarz (Grossschreibung) und *weiss* (kursiv). Diese Schreibweisen zeigen an, dass es sich nicht um eigentliche Hautfarben, sondern um politische und soziale Konstruktionen handelt.[[1]](#footnote-2)
* Ergänzen: Die AG hat sich in der Erarbeitung intensiv mit rassistischen Begriffen befasst und sich schliesslich für gemeinsame Richtlinien entschieden. Die Reflexion zu einigen – in diesem Handbuch oft verwendeten Begriffen – sind im zweiten Teil des Handbuchs nachzulesen. Die thematisierten Begriffe sind durch eine Markierung visuell hervorgehoben (und durch einen Hyperlink mit dem entsprechenden Eintrag verknüpft).